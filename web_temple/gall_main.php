...
{
var my;
my=window.open('http://localhost/temples/tmp.php','_self');
...
<center><img class="title" src="tmp.gif"></center>
...
<img id="imgmain" src="5.gif" style="visibility:visible; position:absolute; TOP:220px; LEFT:450px;WIDTH:400px; HEIGHT:300px";>
