...
<img id="im9vis" src="rang1.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:3450px; WIDTH:50px; HEIGHT:50px";>
<img id="im10vis" src="rang2.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:3450px; WIDTH:50px; HEIGHT:50px";>
<img id="im11vis" src="govind.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:4155px; WIDTH:50px; HEIGHT:50px";>
<img id="im12vis" src="bala.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:4850px; WIDTH:50px; HEIGHT:50px";>
<img id="im13vis" src="bala1.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:4850px; WIDTH:50px; HEIGHT:50px";>
<img id="im14vis" src="shah1.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:5550px; WIDTH:50px; HEIGHT:50px";>
<img id="im15vis" src="shah2.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:5550px; WIDTH:50px; HEIGHT:50px";>
...
place by all traditions of Hinduism.The 
major tradition followed in the area is 
Vaisnavism,and it is a center of learning 
with many Vrindavan Ashrams operating.Its 
a center of Krishna worship and the area 
includes places like Govardhana and Gokul 
that are associated with Krishna.

  <img id="im1" style="position:absolute; WIDTH:120; HEIGHT:90;" src="vrindavan.jpg" onClick="enlarge(1)" onMouseout="shrink(1)"></img>                                       <img id="im2" style="position:absolute; WIDTH:85px; HEIGHT:100px;" src="bnke.jpg" onClick="enlarge(2)"onMouseout="shrink(2)"></img>
                         



    Lord Krishna            Banke Bihariji                                                                                                                                                                                        
</pre></b></div>
<div class="a2">
<b><pre class="fonts">
        MADAN MOHAN TEMPLE
...
by Kapur Ram Das of Multan.This is the 
oldest temple in Vrindavan.The temple 
is closely associated with the saint 
Chaitanya Mahaprabhu.  <img id="im3" style="position:absolute; WIDTH:110; HEIGHT:80;" src="madan_mohan.gif"onClick="enlarge(3)" onMouseout="shrink(3)" ></img>
The original image of 
Lord Madan Gopal was 
shifted from the shrine 
to Karauli in Rajasthan for safe keeping 
during Aurangzeb's rule.Today, a replica 
of the image is worshiped at the temple.
...
<b><pre class="fonts">
    ...
    Built in 1862 is the most popular shrine 
at Vrindavan. The image of Banke-Bihari 
was discovered in Nidhi Vana by Swami 
Haridas, the great Krishna devotee, 
belonging to the Nimbarka Sampradaya.

	<img id="im4" style="position:absolute; WIDTH:70; HEIGHT:85;" src="bih1.jpg" onClick="enlarge(4)" onMouseout="shrink(4)"></img>                                 <img id="im5" style="position:absolute; WIDTH:85; HEIGHT:70;" src="bih2.gif" onClick="enlarge(5)"onMouseout="shrink(5)"></img>




	<img id="im6" style="position:absolute; WIDTH:85; HEIGHT:70;" src="bih3.jpg" onClick="enlarge(6)" onMouseout="shrink(6)"></img>                                 <img id="im7" style="position:absolute; WIDTH:85; HEIGHT:70;" src="bih4.jpg" onClick="enlarge(7)"onMouseout="shrink(7)"></img>
...
<b><pre class="fonts">
	...
	Harivansh Mahaprabhu, has the 
	crown of Radharani placed next 
	to the Shri Krishna image in 
	the sanctum.
...
Ranganatha or Rangaji depicted as Lord 
Vishnu in his sheshashayi pose, resting 
on the coils of the sacred Sesha Naga. 
The temple built in the Dravidian style 
has a tall gopuram, of six storeys 
and a gold - plated Dhwaja stambha, 50 
feet high. A water tank and a picturesque 
garden lie within the temple enclosure. 
The annual festival of Jal Vihar of the 
presiding deity is performed with great 
pomp and splendour at the tank.
...
<b><pre class="fonts">
          GOVIND DEO TEMPLE
		    ...
		    <img id="im11" style="position:absolute; WIDTH:110; HEIGHT:80;" src="govind.gif"onClick="enlarge(11)" onMouseout="shrink(11)" ></img>

    

    Was once a magnificent seven storeyed 
structure built in the form of a Greek 
cross. It is said that the Emperor Akbar 
donated some of the red sandstone that 
had been brought for the Red Fort at Agra, 
for the construction of this temple. Built 
at the astronomical cost of one crore rupees 
...
for Krishna Consciousness (ISKCON) in 
a location known as 'Raman-Reti', is 
one of the most beautiful temples in 
Vrindavan today. The principal deities 
of this temple are Krishna & Balaram, 
with Radha-Shyamasundar and Gaura-Nitai 
alongside. Adjoining the temple is the 
samadhi of A. C. Bhaktivedanta Swami 
Prabhupada, the founder of ISKCON, 
built in pure white marble.
<img id="im12" style="position:absolute; WIDTH:100; HEIGHT:80;" src="bala.gif" onClick="enlarge(12)" onMouseout="shrink(12)"></img>                                       <img id="im13" style="position:absolute; WIDTH:110; HEIGHT:80;" src="bala1.gif" onClick="enlarge(13)"onMouseout="shrink(13)"></img>
</pre></b>
...
spiral columns each 15 feet high. The 
'Basanti Kamra' - the darbar hall is famed 
for its Belgian glass chandeliers 
and fine paintings.
        <img id="im14" style="position:absolute; WIDTH:80; HEIGHT:60;" src="shah1.gif" onClick="enlarge(14)" onMouseout="shrink(14)"></img>                                <img id="im15" style="position:absolute; WIDTH:80; HEIGHT:60;" src="shah2.gif" onClick="enlarge(15)"onMouseout="shrink(15)"></img>
</pre></b>
</div>
