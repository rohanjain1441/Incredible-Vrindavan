...
<img id="im2vis" src="braj2.jpg" style="visibility:hidden; position:absolute; TOP:250px; LEFT:645px; WIDTH:50px; HEIGHT:50px";>

<img id="im4vis" src="1.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:2050px; WIDTH:50px; HEIGHT:50px";>
<img id="im5vis" src="2.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:2050px; WIDTH:50px; HEIGHT:50px";>


<img id="im9vis" src="3.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:3450px; WIDTH:50px; HEIGHT:50px";>
<img id="im10vis" src="4.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:3450px; WIDTH:50px; HEIGHT:50px";>
<img id="im11vis" src="5.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:4155px; WIDTH:50px; HEIGHT:50px";>
<img id="im12vis" src="9.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:5550px; WIDTH:50px; HEIGHT:50px";>
<img id="im13vis" src="10.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:5550px; WIDTH:50px; HEIGHT:50px";>
<img id="im14vis" src="11.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:5550px; WIDTH:50px; HEIGHT:50px";>
<img id="im15vis" src="12.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:5550px; WIDTH:50px; HEIGHT:50px";>
<img id="im16vis" src="6.gif" style="visibility:hidden; position:absolute; TOP:250px; LEFT:4155px; WIDTH:50px; HEIGHT:50px";>
<div class="a1">
<b><pre class="fonts">
  BRAJ-VRINDAVAN HERITAGE 
            ALLIANCE (BVHA)
  
     In January 2010 an alliance was 
formed to act as one voice for future 
development plans in the Braj Mandal. 
The BVHA meets weekly in a different 
temple location and all are invited 
to help achieve mutual goals to do 
with preservation of heritage, pollution,
currrent developments and other urgent 
matters concerning the Holy Dham.

  <img id="im1" style="position:absolute; WIDTH:110; HEIGHT:80;" src="braj1.jpg" onClick="enlarge(1)" onMouseout="shrink(1)"></img>                                       <img id="im2" style="position:absolute; WIDTH:110px; HEIGHT:80px;" src="braj2.jpg" onClick="enlarge(2)"onMouseout="shrink(2)"></img>
...
with the support of WWF-India through 
a Vrindavan Conservation project over 
five years. Since then FOV-India initially 
with the support of FOV-UK has carried 
on tree plantation activities and 
maintains a nursery to propogate, conserve 
and distribute typical tree varieties of 
Braj.In 2001 the Chief Forestry 
Conservator of Uttar Pradesh awarded 
FOV for their massive tree plantation 
efforts.
...
<b><pre class="fonts">
        TREE PLANTATION AND 
                 DISTRIBUTION
                  ...
                  <img id="im4" style="position:absolute; WIDTH:140; HEIGHT:100;" src="1.gif" onClick="enlarge(4)" onMouseout="shrink(4)"></img>                                 


       

       
                  <img id="im5" style="position:absolute; WIDTH:140; HEIGHT:100;" src="2.gif" onClick="enlarge(5)"onMouseout="shrink(5)"></img>




     2010 UP Pollution Control board 
   Plantation Drive at Bhole Baba temple
...
development work is an attempt towards 
improving development practices so as 
to enhance its contribution to the
response to HIV/AIDS. This requires 
developmental organizations to attend 
to both the immediate and the underlying 
determinants of people’s susceptibility 
to HIV infection and taking into account 
the impact of HIV/AIDS and adjusts their 
work based on it. 
...
<b><pre class="fonts">
     ...
     Given this scenario, involvement of 
NGOs from varied capacities and 
backgrounds becomes crucial for effective 
response to HIV in India, especially in 
dealing with HIV, where complexities are 
...
are woven by local women out of grass and 
recycled plastic bags. This is a project 
sponsored by FOV in an effort to clean up 
the environment and financially empower 
...
Prosperity, Mumbai, Ms. Radhika, famous 
tarot reader, Mr. Madhumangal Shukla,
environment activist, Mr. K. B. Mahajan 
and Mr. Swapan Goswami addressed the 
school children on how the spirituality 
is linked with the environment.
...
Daadi Nani ki Kahani-book written by Ms. 
Shakun Narain was distributed among the 
school children.
